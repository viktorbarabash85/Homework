...
def search_operations_by_description(operations: List[Dict[str, Any]], search_term: str) -> Union[str, List[Dict[str, Any]]]:
    """
...
def count_operations_by_category(operations: List[Dict[str, Any]], category_count: Dict[str, int] = None) -> Dict[
    str, int]:
    """
